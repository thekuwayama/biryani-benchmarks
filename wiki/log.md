...
- `e98f95b4fd` は 2026-06-06 マージのため 4.0.5 には**未含**。unset は旧来の `default_max_cpu = 8`
- unset: 7,464 req/s（4.0.2 比 +4.3%）— PR 効果ではなく 4.0.5 の他の改善によるもの
- ピーク: cpu=2（8,456 req/s）— 4.0.2 では cpu=4 がピーク。4.0.5 内の他のスケジューラ変更の影響か
