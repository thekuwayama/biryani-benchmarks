...
| -c25 -m50 Ruby 4.0.5 unset（=8 固定） | 1,300 | **7,464**（4.0.2 比 +4.3%、PR 未含） |
...
- デフォルト SNT 上限: `default_max_cpu` = 物理 CPU 数（マージ済み（e98f95b4fd、2026-06-06）。Ruby 4.0.5 には未含、次リリース以降に入る。変更前は固定値 8）
